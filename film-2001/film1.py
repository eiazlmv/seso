...
cl = LINETCR.LINE()
cl.login(token="EsCT7ZIvfQdGA0lCVrEf.ojrVNBavyXp4qPwMrR1YJW.9+WSMhgfDi0L3awZc9fpy+7yG+SRMjFzXkn7491a5BM=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u38946f9db0156313f84295a646bd728f",mid]
self = ["u38946f9db0156313f84295a646bd728f",mid]
admin = "u38946f9db0156313f84295a646bd728f"
admsa = "u38946f9db0156313f84295a646bd728f"
owner = "u38946f9db0156313f84295a646bd728f"
adminMID = "u38946f9db0156313f84295a646bd728f"
Creator = "u38946f9db0156313f84295a646bd728f"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"เงี่ยนก็ไปชักว่าวดิ . 👉👌💦")
                        ...
                        cl.sendText(msg.to,"ขําไรวะขําด้วยคนดิ555")
